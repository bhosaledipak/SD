											...
											<div class="art-post-inner art-article">
												...
												<div class="art-postcontent">
														<?php
															...
															$serviceKeywords = $_REQUEST['serviceKeywords'];
															$catOfService = $_REQUEST['catOfService'];
															$priority = $_REQUEST['priority'];
															include 'RequirementDAO.php';
															$req = new RequirementDAO();
															$req->getSearch($typeOfService,$serviceKeywords,$catOfService,$priority);
															$rs = $req->getResult();														
															...
															if($row[5] == 'Yes') {
																$i++;
																print 'Fullfiled by Provider : '.$row[8];
															} else {
																//Dump to the Data Base
																$req->addRequirements($typeOfService,$serviceKeywords,$catOfService,$priority);
																print 'Thanks for Publishing..!!';
															}												      													      		 												 											  			
														?>
												</div>
												<div class="cleared"></div>
